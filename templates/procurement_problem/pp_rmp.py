...
class RMP():
    ...
    def __init__(self, pp: ProcurementProblem):
        ...
        # TODO: Creates an empty objective
        

        # TODO: Creates the complicating constraints
        
        # TODO: Creates the convexity constraints
	...
	# We pass the coefficient of the constraint in which it appears.
        ...
        # TODO: Add the new variable starting from the column created.
